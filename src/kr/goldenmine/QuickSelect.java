...
public class QuickSelect {
                                ...
                                int high)
    {
        ...
        for (int i = low; i <= high; i++) {
            ...
            if (arr[i] < pivot) {
                ...
                System.out.println("swap " + pivotLoc + " " + i + ", " + pivot + ", " + Arrays.toString(arr));
        ...
        System.out.println("swap " + pivotLoc + " " + high + ", " + pivot + ", " + Arrays.toString(arr));
                                  ...
                                  int high, int k)
    {
        ...
        System.out.println("partition: " + partition + ", " + low + ", " + high);
    ...
    {
        int[] array = new int[] { 10, 4, 5, 8, 6, 11, 9 };
        int[] arraycopy = new int[] { 10, 4, 5, 8, 6, 11, 9 };
