package kr.goldenmine.baekjoon.silver.silver1.p15724;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int y = 1; y <= Y; y++) {
            for(int x = 1; x <= X; x++) {
                map[y][x] = scan.nextInt() + map[y - 1][x] + map[y][x - 1] - map[y - 1][x - 1];
            }
        }
        ...
        while(T-- > 0) {
            ...
            w.writeInt(map[y2][x2] - map[y1][x2] - map[y2][x1] + map[y1][x1]);
            w.write('\n');
        }
        w.close();
    }
