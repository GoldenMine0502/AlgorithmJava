package kr.goldenmine.baekjoon.silver.silver4.p13413;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(T-- > 0) {
            scan.nextInt();
            String a = scan.nextString();
            String b = scan.nextString();
...
//            System.out.println(count + (count1 - count) + (count0 - count));
            w.writeInt(count0 + count1 - count);
            w.write('\n');
        }
        w.close();
    }
