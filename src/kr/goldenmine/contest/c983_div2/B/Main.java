package kr.goldenmine.contest.c983_div2.B;
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(T-- > 0) {
            ...
            if(firstSequenceLen == 0 || lastSequenceLen == 0) {
                w.writeString("-1\n");
            } else if(lastSequenceLen % 2 != 0) { // m3가 홀수개면 무조건 성립함
                w.writeInt(3);
                w.write('\n');
                w.writeInt(m1);
                w.write(' ');
                ...
                w.writeInt(m3);
                w.write('\n');
            } else { // 짝수개인 경우 5개로 가능함
                // 2개면 1 1 -> 2개
                // 4개면 1 1 -> 2개
                // 6개면 1 5 -> 2개
                // 8개면 1 7 -> 2개 항상 2개로 만들 수 있겠네.
                // 10개면 5 5 -> 2개
                if(N >= 5) {
                    w.writeInt(5);
                    w.write('\n');
